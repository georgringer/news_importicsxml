...
class FaviconTest extends PHPUnit_Framework_TestCase
{
    public function testExtract()
    {
        ...
        self::assertEquals(['http://example.com/myicon.ico'], $favicon->extract($html));
        ...
        self::assertEquals(['http://example.com/image.ico'], $favicon->extract($html));
        ...
        self::assertEquals(['http://example.com/image.png'], $favicon->extract($html));
        ...
        self::assertEquals(['http://example.com/image.png', 'http://example.com/image.ico'], $favicon->extract($html));
        ...
        self::assertEquals([], $favicon->extract($html));

        // empty array on no input
        self::assertEquals([], $favicon->extract(''));
    ...
    public function testExists()
    {
        ...
        self::assertTrue($favicon->exists('https://miniflux.net/favicon.ico'));
        self::assertFalse($favicon->exists('http://minicoders.com/favicon.ico'));
        self::assertFalse($favicon->exists('http://blabla'));
    ...
    public function testFind_inMeta()
    {
        ...
        self::assertNotEmpty($favicon->getContent());
    }
    ...
    public function testFind_noIcons()
    {
        ...
        self::assertEmpty($favicon->getContent());
    }
    ...
    public function testDataUri()
    {
        ...
        self::assertEquals($expected, $favicon->getDataUri());
    }
    ...
    {
        $favicon = new Favicon();
        self::assertNotEmpty($favicon->find('http://www.lemonde.fr/'));
